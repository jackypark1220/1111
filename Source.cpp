...
//}
//
//bool inrec(const double x, const double y, const double x_c = 1.5, const double y_c = 0.5, const double w_c = 3.0, const double h_c = 0.5) {
...
//}
//bool inCircle(const double x, const double y, const double x_c = 0.5, const double y_c = 0.5, const double r_c = 0.5) {
//	return (x - x_c)*(x - x_c) + (y - y_c)* (y - y_c) < r_c*r_c;
//}
//void main() {
